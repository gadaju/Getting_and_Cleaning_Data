...
setwd("C:/Users/Gabriel/Documents/R/3 getting and Cleaning data/data")
library(plyr)
...
# OBJ 5: From the data set in step 4, creates a second, independent tidy data set 
